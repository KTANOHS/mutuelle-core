...
def diagnostic_complet_assureur():
    ...
    # 4. VÉRIFICATION DES DONNÉES MÉTIER (sans imports problématiques)
    ...
    # Essayer d'importer les autres modèles avec gestion d'erreurs
    try:
        ...
        print(f"\n💰 Paiements: Module non disponible")
