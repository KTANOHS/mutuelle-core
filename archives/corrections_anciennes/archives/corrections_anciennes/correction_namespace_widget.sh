# correction_namespace_widget.sh
#!/bin/bash

echo "🔧 CORRECTION DU NAMESPACE DANS LE WIDGET"

# Vérifier l'appel actuel dans le widget
echo "📋 Appel API actuel dans le widget:"
grep -n "api_last_activity" templates/includes/communication_widget.html

# Créer une version corrigée avec le bon namespace
cat > templates/includes/communication_widget_corrige.html << 'WIDGET_EOF'
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Charger la dernière activité - AVEC LE BON NAMESPACE
    function loadLastActivity() {
        fetch('{% url "communication_api:api_last_activity" %}')
...
cp templates/includes/communication_widget.html templates/includes/communication_widget.html.backup.namespace
cp templates/includes/communication_widget_corrige.html templates/includes/communication_widget.html
rm templates/includes/communication_widget_corrige.html

echo "✅ Widget corrigé avec le bon namespace"
echo "💡 Changement: 'communication:api_last_activity' → 'communication_api:api_last_activity'"
EOF
