# creation_sidebar_assureur.sh
#!/bin/bash

echo "📁 CRÉATION DE LA SIDEBAR ASSUREUR"

mkdir -p templates/assureur/partials

cat > templates/assureur/partials/_sidebar.html << 'EOF'
...
echo "✅ Sidebar assureur créée: templates/assureur/partials/_sidebar.html"
EOF
